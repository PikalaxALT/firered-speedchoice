...
#define PRINTER_STATE_PRINTCHAR    0
#define PRINTER_STATE_WAITBUTTON   1
#define PRINTER_STATE_PROMPTCLEAR  2
#define PRINTER_STATE_PROMPTSCROLL 3
#define PRINTER_STATE_DOSCROLL     4
#define PRINTER_STATE_WAITSE       5
#define PRINTER_STATE_PAUSE        6

#define PRINTER_RET_CONTINUE       0
#define PRINTER_RET_TERMINATE      1
#define PRINTER_RET_CONTROL        2
#define PRINTER_RET_WAIT           3
