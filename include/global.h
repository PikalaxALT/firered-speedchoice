...
#define Q_8_8(n) ((fx16)((n) * 256))

// Converts a number to Q4.12 fixed-point format
#define Q_4_12(n)  ((fx16)((n) * 4096))

// Converts a number to Q24.8 fixed-point format
#define Q_24_8(n)  ((fx32)((n) * 256))

// Converts a number to Qn.s fixed-point format
#define Q_N_S(n, s) ((fx16)((n) * (1 << (s))))
...
// Converts a Qn.s fixed-point format number to a regular integer
#define Q_N_S_TO_INT(n, s)  ((int)((n) >> (s)))
...
{
    /*0x00*/          u32 expsystem:2;
                      u32 plotless:2;
                      u32 instantText:1;
                      u32 earlySurf:1;
                      u32 spinners:2;
    /*0x01*/          u32 maxVision:2;
                      u32 newwildencounters:1;
                      u32 runEverywhere:1;
                      u32 betterMarts:1;
                      u32 goodEarlyWilds:2;
                      u32 niceMenuOrder:1;
    /*0x02*/          u32 easyFalseSwipe:2;
...
struct SaveBlock2
{
    ...
    /*0x013*/ u8 optionsButtonMode;  // OPTIONS_BUTTON_MODE_[HELP/LR/L_EQUALS_A]
    /*0x014*/ u16 optionsTextSpeed:3; // OPTIONS_TEXT_SPEED_[SLOW/MID/FAST/INST]
              u16 optionsWindowFrameType:5; // Specifies one of the 10 decorative borders for text boxes
